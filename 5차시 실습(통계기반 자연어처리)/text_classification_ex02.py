...
print("Best params:", gs_tfidf.best_params_)
print("Best macro-F1 (cv):", gs_tfidf.best_score_)

# 테스트
best_gs_tfidf = gs_tfidf.best_estimator_
y_pred = best_gs_tfidf.predict(x_te)
print(classification_report(y_te, y_pred, digits=3))
